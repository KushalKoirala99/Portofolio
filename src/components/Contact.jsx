    ...
    >
      ...
      <div className="max-w-2xl mx-auto mt-20 text-center  ">
        ...
        <p className="text-xl sm:text-2xl mb-8">
          I'd love to hear from you! Feel free to reach out for collaborations, inquiries, or just to connect.
        </p>
        ...
        <form className="space-y-6">
          ...
          <button
            type="submit"
            className="bg-orange-500 border text-white py-2 px-6 rounded-lg text-lg sm:text-xl hover:bg-orange-400 transition duration-300"
          >
            Send Message
          </button>
        </form>
        ...
        <div className=' w-full  mt-3 flex justify-center'>
          ...
          className='h-12 w-h-12 mr-4  m:h-18 mb-4'></img></a>
          <a href="https://www.linkedin.com/in/kushal-koirala-448931260/" target='blank'><img 
          src={linkdenIcon}
          className='h-12 w-h-12 ml-4 m:h-18 mb-4'></img></a>
        </div>
    </section>
  );
};
